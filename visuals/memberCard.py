...
<svg 
    ...
    <!-- Card base with subtle gradient effect -->
    ...
    <g transform="translate(112.5, 100)">
        ...
        <path d="M -45 -40 L 45 -40 L 45 10 C 45 35 0 55 0 55 C 0 55 -45 35 -45 10 Z" 
              fill="none" stroke="{accent_color}" stroke-width="1.5" opacity="0.8"/>
        
        <!-- Inner shield -->
        <path d="M -35 -30 L 35 -30 L 35 8 C 35 28 0 45 0 45 C 0 45 -35 28 -35 8 Z" 
              fill="none" stroke="{accent_color}" stroke-width="0.5" opacity="0.4"/>
        
        <!-- Symbol based on team type -->
        {"<!-- Authentic: Checkmark/Verified symbol -->" if card_type == "AUTHENTIC" else "<!-- Fraudulent: X/Alert symbol -->"}
        {"<path d=\"M -20 5 L -5 20 L 25 -15\" fill=\"none\" stroke=\"" + accent_color + "\" stroke-width=\"3\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/>" if card_type == "AUTHENTIC" else "<g stroke=\"" + accent_color + "\" stroke-width=\"2.5\" stroke-linecap=\"round\"><line x1=\"-15\" y1=\"-10\" x2=\"15\" y2=\"20\"/><line x1=\"15\" y1=\"-10\" x2=\"-15\" y2=\"20\"/></g>"}
    </g>
    ...
    <!-- Decorative line under team name -->
    <!-- line x1="70" y1="195" x2="155" y2="195" stroke="{accent_color}" stroke-width="1" opacity="0.5" /-->
    
    <!-- Divider -->
    <line x1="30" y1="210" x2="195" y2="210" stroke="{accent_color}" stroke-width="0.5" opacity="0.3" />
    
    <!-- Instructions section -->
    <text x="112.5" y="222" font-family="Courier New, monospace" font-size="6" fill="{accent_color}" text-anchor="middle" font-weight="bold">OBJECTIVE</text>
    <text x="112.5" y="232" font-family="Arial, sans-serif" font-size="6" fill="{accent_color}" text-anchor="middle" opacity="0.7">
        {"Expose fraudulent food suppliers" if card_type == "AUTHENTIC" else " "}
        {"Evade detection and sell" if card_type == "FRAUDULENT" else " "}
    </text>
    <text x="112.5" y="242" font-family="Arial, sans-serif" font-size="6" fill="{accent_color}" text-anchor="middle" opacity="0.7">
    ...
    <text x="112.5" y="242" font-family="Arial, sans-serif" font-size="6" fill="{accent_color}" text-anchor="middle" opacity="0.7">
        {" " if card_type == "AUTHENTIC" else " "}
    </text>
    
    <!-- Bottom decorative element -->
    <g transform="translate(112.5, 270)">
        <circle cx="0" cy="0" r="8" fill="none" stroke="{accent_color}" stroke-width="0.8" opacity="0.5"/>
        <circle cx="0" cy="0" r="4" fill="none" stroke="{accent_color}" stroke-width="0.5" opacity="0.4"/>
    </g>
