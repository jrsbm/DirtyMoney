...
<svg 
    ...
    <text x="18" y="61" font-family="monospace" font-size="4.5" fill="{accent_color}" opacity="0.8">Product: Olive Oil (Extra Virgin)</text>
...
///    
    ...
    <text x="118" y="224" font-family="monospace" font-size="4" fill="{accent_color}" opacity="0.8">Absent</text>
    ...
    <text x="113" y="251" font-family="monospace" font-size="4" fill="{accent_color}" opacity="0.8">0.034 mcg/Serving</text>
